		...
		<div className="flex flex-col md:flex-row gap-2">
			{DIFFERENT_LESSONS.map((lesson, index) => (
				...
				>
					<button
						onClick={() => {
							handleNavigate(lesson.href);
						}}
						className="flex h-full  flex-col gap-2 p-4 w-full hover:border-2 border-yellow-500 hover:shadow-xl transition ease-in-out duration-500 rounded-md bg-slate-200 items-between justify-between text-center"
					>

"use strict";(()=>{var e={};e.id=468,e.ids=[468],e.modules={72934:e=>{e.exports=require("next/dist/client/components/action-async-storage.external.js")},54580:e=>{e.exports=require("next/dist/client/components/request-async-storage.external.js")},45869:e=>{e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},35900:e=>{e.exports=require("pg")},39491:e=>{e.exports=require("assert")},14300:e=>{e.exports=require("buffer")},6113:e=>{e.exports=require("crypto")},82361:e=>{e.exports=require("events")},13685:e=>{e.exports=require("http")},95687:e=>{e.exports=require("https")},63477:e=>{e.exports=require("querystring")},57310:e=>{e.exports=require("url")},73837:e=>{e.exports=require("util")},59796:e=>{e.exports=require("zlib")},65089:(e,r,s)=>{s.r(r),s.d(r,{headerHooks:()=>m,originalPathname:()=>q,patchFetch:()=>x,requestAsyncStorage:()=>w,routeModule:()=>p,serverHooks:()=>$,staticGenerationAsyncStorage:()=>y,staticGenerationBailout:()=>f});var t={};s.r(t),s.d(t,{GET:()=>l,POST:()=>d});var n=s(95419),i=s(69108),o=s(99678),a=s(68582),u=s(81355),c=s(23106);async function l(e){try{let e=await (0,u.getServerSession)(a.Z),r=`
                SELECT balance FROM balances WHERE user_id = $1
            `,s=await c.d.query(r,[e.user.id]);return Response.json(s.rows[0])}catch(e){return Response.json(e.message,{status:500})}}async function d(e){try{let r=await (0,u.getServerSession)(a.Z),s=await e.json(),t=`
            INSERT INTO balances ("userId", balance) VALUES ($1, $2)
        `;return await c.d.query(t,[r.user.id,s.balance]),Response.json({success:!0})}catch(e){return Response.json(e.message,{status:500})}}let p=new n.AppRouteRouteModule({definition:{kind:i.x.APP_ROUTE,page:"/api/balance/route",pathname:"/api/balance",filename:"route",bundlePath:"app/api/balance/route"},resolvedPagePath:"/home/Frasier/Documents/web/JLSM/jlsm/app/api/balance/route.ts",nextConfigOutput:"",userland:t}),{requestAsyncStorage:w,staticGenerationAsyncStorage:y,serverHooks:$,headerHooks:m,staticGenerationBailout:f}=p,q="/api/balance/route";function x(){return(0,o.patchFetch)({serverHooks:$,staticGenerationAsyncStorage:y})}},68582:(e,r,s)=>{s.d(r,{Z:()=>o});var t=s(23106),n=s(10375),i=s(50694);let o={adapter:function(e){return{async createVerificationToken(r){let{identifier:s,expires:t,token:n}=r,i=`
